  ...
  return (
    <div className="solo-card">
      <div className="inner-card">
        ...
        <h3>
          <strong>Abode Haven</strong> is an app for Abode Haven's building
          management admin and their apartments.
          <ul>
            <li>
              Admin can add, update, delete buildings and apartments based on
              availability.
            </li>
