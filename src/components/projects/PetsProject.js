  ...
  return (
    <div className="solo-card">
      <div className="inner-card">
        ...
        <h3>
          <strong>Adopt A Pet</strong> is an app for adopting/maintaining a
          virtual pet without the upkeep of a live one.
          <ul>
            <li>Persists each user to a Postgres database.</li>
            <li>
              Rebuilt from a Single Page Application with Javascript to React
              frontend and a Rails API with JWT authorization.
            </li>
